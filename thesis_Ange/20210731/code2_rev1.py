...
def hist(score,a,b):
    ...
    x = ['Option 1 \n One \n Delivery \n Person', 'Option 2 \n Autonomous \n Robots', 'Option 3 \n Drones', 'Option 4 \n Package \n Stations', 'Option 5 \n Longer \n Waiting']
    scores = score.sum()
    normalized=[float(i)/sum(scores) for i in scores]
    
    x_pos = [i for i, _ in enumerate(x)]

    plt.bar(x_pos, normalized, color=b)
    #plt.xlabel("Options")
    plt.ylabel("Scores")
    plt.title(a)
    plt.xticks(x_pos, x)
...
# option-1
df.loc[(df['opt1-one delivery person'] == 1.0) | (df['opt1-one delivery person'] == 2.0)]['Age'].value_counts(normalize=True).plot(kind='bar',color='green',title='Scores 1&2 given to Option-1 \n according to Ages')
df.loc[(df['opt1-one delivery person'] == 1.0) | (df['opt1-one delivery person'] == 2.0)]['Employment'].value_counts(normalize=True).plot(kind='bar',color='red',title='Scores 1&2 given to Option-1 \n according to Employment')
df.loc[(df['opt1-one delivery person'] == 1.0) | (df['opt1-one delivery person'] == 2.0)]['Haushaltsgröße'].value_counts(normalize=True).plot(kind='bar',color='blue',title='Scores 1&2 given to Option-1 \n according to Households')
df.loc[(df['opt1-one delivery person'] == 1.0) | (df['opt1-one delivery person'] == 2.0)]['Wohnsituation'].value_counts(normalize=True).plot(kind='bar',color='orange',title='Scores 1&2 given to Option-1 \n according to Residencial')

# option-2
df.loc[(df[option_columns[1]] == 1.0) | (df[option_columns[1]] == 2.0)]['Age'].value_counts(normalize=True).plot(kind='bar',color='green',title='Scores 1&2 given to Option-2 \n according to Ages')
df.loc[(df[option_columns[1]] == 1.0) | (df[option_columns[1]] == 2.0)]['Employment'].value_counts(normalize=True).plot(kind='bar',color='red',title='Scores 1&2 given to Option-2 \n according to Employment')
df.loc[(df[option_columns[1]] == 1.0) | (df[option_columns[1]] == 2.0)]['Haushaltsgröße'].value_counts(normalize=True).plot(kind='bar',color='blue',title='Scores 1&2 given to Option-2 \n according to Households')
df.loc[(df[option_columns[1]] == 1.0) | (df[option_columns[1]] == 2.0)]['Wohnsituation'].value_counts(normalize=True).plot(kind='bar',color='orange',title='Scores 1&2 given to Option-2 \n according to Residencial')

# option-3
df.loc[(df[option_columns[2]] == 1.0) | (df[option_columns[2]] == 2.0)]['Age'].value_counts(normalize=True).plot(kind='bar',color='green',title='Scores 1&2 given to Option-3 \n according to Ages')
df.loc[(df[option_columns[2]] == 1.0) | (df[option_columns[2]] == 2.0)]['Employment'].value_counts(normalize=True).plot(kind='bar',color='red',title='Scores 1&2 given to Option-3 \n according to Employment')
df.loc[(df[option_columns[2]] == 1.0) | (df[option_columns[2]] == 2.0)]['Haushaltsgröße'].value_counts(normalize=True).plot(kind='bar',color='blue',title='Scores 1&2 given to Option-3 \n according to Households')
df.loc[(df[option_columns[2]] == 1.0) | (df[option_columns[2]] == 2.0)]['Wohnsituation'].value_counts(normalize=True).plot(kind='bar',color='orange',title='Scores 1&2 given to Option-3 \n according to Residencial')

# option-4
df.loc[(df[option_columns[3]] == 1.0) | (df[option_columns[3]] == 2.0)]['Age'].value_counts(normalize=True).plot(kind='bar',color='green',title='Scores 1&2 given to Option-4 \n according to Ages')
df.loc[(df[option_columns[3]] == 1.0) | (df[option_columns[3]] == 2.0)]['Employment'].value_counts(normalize=True).plot(kind='bar',color='red',title='Scores 1&2 given to Option-4 \n according to Employment')
df.loc[(df[option_columns[3]] == 1.0) | (df[option_columns[3]] == 2.0)]['Haushaltsgröße'].value_counts(normalize=True).plot(kind='bar',color='blue',title='Scores 1&2 given to Option-4 \n according to Households')
df.loc[(df[option_columns[3]] == 1.0) | (df[option_columns[3]] == 2.0)]['Wohnsituation'].value_counts(normalize=True).plot(kind='bar',color='orange',title='Scores 1&2 given to Option-4 \n according to Residencial')

# option-5
df.loc[(df[option_columns[4]] == 1.0) | (df[option_columns[4]] == 2.0)]['Age'].value_counts(normalize=True).plot(kind='bar',color='green',title='Scores 1&2 given to Option-5 \n according to Ages')
df.loc[(df[option_columns[4]] == 1.0) | (df[option_columns[4]] == 2.0)]['Employment'].value_counts(normalize=True).plot(kind='bar',color='red',title='Scores 1&2 given to Option-5 \n according to Employment')
df.loc[(df[option_columns[4]] == 1.0) | (df[option_columns[4]] == 2.0)]['Haushaltsgröße'].value_counts(normalize=True).plot(kind='bar',color='blue',title='Scores 1&2 given to Option-5 \n according to Households')
df.loc[(df[option_columns[4]] == 1.0) | (df[option_columns[4]] == 2.0)]['Wohnsituation'].value_counts(normalize=True).plot(kind='bar',color='orange',title='Scores 1&2 given to Option-5 \n according to Residencial')


#For the option 1:
#- What kind of people (their age, work fulltime or parttime, household situation, residential (urban or rural)) 
# who choose option 1
df.loc[df[option_columns[0]] == 1.0]['Age'].value_counts(normalize=True).plot(kind='bar',color='green',title='Scores 1 given to Option-1 \n according to Ages')
df.loc[df[option_columns[0]] == 1.0]['Employment'].value_counts(normalize=True).plot(kind='bar',color='red',title='Score 1 given to Option-1 \n according to Employment')
df.loc[df[option_columns[0]] == 1.0]['Haushaltsgröße'].value_counts(normalize=True).plot(kind='bar',color='blue',title='Score 1 given to Option-1 \n according to Households')
df.loc[df[option_columns[0]] == 1.0]['Wohnsituation'].value_counts(normalize=True).plot(kind='bar',color='orange',title='Score 1 given to Option-1 \n according to Residencial')
...
df.loc[df['if you chose this option'] == uniquefeevalues[2]]['Age'].value_counts(normalize=True).plot(kind='bar',color='green',title='People chose Option-1 who are willing to pay \n 0,51-1€ according to Ages')
df.loc[df['if you chose this option'] == uniquefeevalues[2]]['Employment'].value_counts(normalize=True).plot(kind='bar',color='red',title='People chose Option-1 who are willing to pay \n 0,51-1€ according to Employment')
df.loc[df['if you chose this option'] == uniquefeevalues[2]]['Haushaltsgröße'].value_counts(normalize=True).plot(kind='bar',color='blue',title='People chose Option-1 who are willing to pay \n 0,51-1€ according to Households')
df.loc[df['if you chose this option'] == uniquefeevalues[2]]['Wohnsituation'].value_counts(normalize=True).plot(kind='bar',color='orange',title='People chose Option-1 who are willing to pay \n 0,51-1€ according to Residencial')

#For the option 1:
#-What kind of people (their age, work fulltime or parttime, household situation) 
# who don’t want to pay an additional cost.
df.loc[df['if you chose this option'] == uniquefeevalues[4]]['Age'].value_counts(normalize=True).plot(kind='bar',color='green',title='People chose Option-1 who don’t want to pay \n an additional cost according to Ages')
df.loc[df['if you chose this option'] == uniquefeevalues[4]]['Employment'].value_counts(normalize=True).plot(kind='bar',color='red',title='People chose Option-1 who don’t want to pay \n an additional cost according to Employment')
df.loc[df['if you chose this option'] == uniquefeevalues[4]]['Haushaltsgröße'].value_counts(normalize=True).plot(kind='bar',color='blue',title='People chose Option-1 who don’t want to pay \n an additional cost according to Households')
df.loc[df['if you chose this option'] == uniquefeevalues[4]]['Wohnsituation'].value_counts(normalize=True).plot(kind='bar',color='orange',title='People chose Option-1 who don’t want to pay \n an additional cost according to Residencial')
